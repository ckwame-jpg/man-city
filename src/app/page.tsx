...
export default function Home() {
  ...
  return (
    <div className={`font-sans ${darkMode ? 'dark' : ''}`} style={{ fontFamily: "'Calibre', 'Inter', 'San Francisco', 'SF Pro Text', -apple-system, system-ui, sans-serif" }}>
      <div className="md:hidden fixed top-0 left-0 right-0 z-50 bg-[#011128] border-b border-white/10 px-6 py-4 flex items-center justify-between">
        ...
        <div className="flex items-center space-x-4">
          ...
          <button
            ...
            className="text-[#F5F5F5] text-sm border px-2 py-1 rounded hover:bg-[#F5F5F5]/10"
          >
            {darkMode ? 'Light' : 'Dark'}
          </button>
          <button
      ...
      <main
        ref={mainRef}
        className="min-h-screen text-[#F5F5F5] px-6 md:px-28 grid grid-cols-1 md:grid-cols-[320px_1fr] gap-52 pt-36 md:pt-20"
        style={{ backgroundColor: '#011128' }}
      >
                ...
                <div key={id} className="group flex items-center space-x-2">
                  <span
                    className={`h-px w-6 transition-all duration-300 ${
                      activeSection === id ? 'bg-[#575365] w-8' : 'bg-[#575365]/30 group-hover:bg-[#575365]'
                    }`}
                  />
                  <a
                    href={`#${id}`}
        ...
        <div className="space-y-32">
          ...
          <section id="projects" className="scroll-mt-16 border-t border-[#363946]/50 pt-10">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h3 className="text-2xl font-bold">habit tracker</h3>
          ...
          <section id="experience" ref={experienceRef} className="scroll-mt-16 border-t border-[#363946]/50 pt-10 pb-60">
